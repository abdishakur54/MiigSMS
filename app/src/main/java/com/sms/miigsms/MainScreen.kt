...
import com.sms.miigsms.components.MessageView
import com.sms.miigsms.components.SenderView
import com.sms.miigsms.model.SMSMessage
import com.sms.miigsms.model.parsedDate
...
fun MainScreen() {
    ...
    LaunchedEffect(key1 = Unit) {
        ...
        allMessages += filteredMessages.sortedBy { it.date }.groupBy { it.sender }
    }
